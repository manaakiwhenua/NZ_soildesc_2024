...
dat_in_sibdepth <-
  tribble(~Code, ~Name, ~Description, ~Hzn,
         's', 'Slow',     '<4 mm/hr', 'Extremely slow, slow',
         'm', 'Moderate', '≥4–<72 mm/hr', 'Moderately slow, moderate',
         'r', 'Rapid',    '≥72 mm/hr', 'Rapid')
