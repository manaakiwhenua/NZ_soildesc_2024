...
For classifying using the NZSC, particular tests down to or at a certain depth may be required to progress through the Key to Soil Orders. At the soil order level, these are:
