...
erDiagram
  ...
  landscape {
    ...
    cat          catu_landscape FK         "Section 4.2.1"
    %% landscape relief %%
    num[0-Inf]   amt_lscape_relief_med_m   "Section 4.2.2.1"
    %% landscape slope %%
    num[0-90]    amt_lscape_slope_med_d    "Section 4.2.2.2"
    num[0-90]    amt_lscape_slope_min_d    "Section 4.2.2.2"
    num[0-90]    amt_lscape_slope_max_d    "Section 4.2.2.2"
  ...
  lscape_struct {
    ...
    cat          catu_lscape_struct FK    "Section 4.2.2.4"
  }
  
  landscape_structs {
    id           id_lscape_struct PK
    cat          catu_landscape_struct FK         "Table 4.3"
    txt          txt_landscape_struct_name        "Table 4.3"
    txt          txt_landscape_struct_desc        "Table 4.3"
  }
  ...
  landform {
    ...
    num[0-100]   amt_landform_p                  "Section 4.2.2.5"
  ...
  landform_types {
    id           id_landform PK
    cat          catu_landform FK           "Table 4.4"
    txt          txt_landform_name          "Table 4.4"
    txt          txt_landform_desc          "Table 4.4"
  }
  ...
  landform_elements {
    ...
    cat         catu_landform_element FK    "Table 4.5"
    txt         txt_landform_element_name   "Table 4.5"
  }
  
  landform_element_vmods {
    id          id_landform_element_vmod PK
    cat         catu_landform_element_vmod FK    "Table 4.6"
    txt         txt_landform_element_vmod_name   "Table 4.6"
    txt         txt_landform_element_vmod_desc   "Table 4.6"
  } 

  landform_element_hmods {
    id          id_landform_element_hmod PK
    cat         catu_landform_element_hmod FK    "Table 4.7"
    txt         txt_landform_element_hmod_name   "Table 4.7"
    txt         txt_landform_element_hmod_desc   "Table 4.7"
  } 
...
erDiagram
  ...
  lithology {
     id         id_lithology PK
    cat         catu_lithology_group FK       "Table 5.1"
...
erDiagram
  ...
  horizon_arch {
    ...
    %% roots rapid %%
    num[0-Inf] amt_total_roots_n                "Section 13.3.1"
    cat        catu_total_roots_pos FK          "Section 13.3.2"
    %% void rapid %%
    num[0-100] amt_total_voids_p                "Section 13.4.1"
    %% pores rapid %%
    bool        ind_pores                        "Section 13.4.2"
    %% pores detailed (could also spin out to subtable) %%
    num[0-Inf]  amt_macropores_n                 "Section 13.4.2"
    num[0-Inf]  amt_micropores_n                 "Section 13.4.2"
    %% Substrate features %%
    %% rapid %%
    cat        cato_bedding_angle               "Section 13.5.3"
    %% routine %%
    num[0-90]  amt_bedding_angle_d              "Section 13.5.3"
    %% detailed %%
    num[0-Inf] amt_bedding_thickness_med        "Section 13.5.3"
    num[0-Inf] amt_bedding_thickness_min        "Section 13.5.3"
    num[0-Inf] amt_bedding_thickness_max        "Section 13.5.3"
    cat        catu_bedding_lithology FK        "Section 5.2"
    cat        catu_fracture_pattern FK         "Section 13.5.4"
    cat        catu_fracture_orientation FK         "Section 13.5.4"
    num[0-Inf] amt_fracture_spacing_med         "Section 13.5.4"
    num[0-Inf] amt_fracture_spacing_min         "Section 13.5.4"
    num[0-Inf] amt_fracture_spacing_max         "Section 13.5.4"
  ...
  horizon_roots {
    ...
    num[0-Inf] amt_root_n                  "Section 13.3.1"
  } 
  ...
  bedding_angles {
    ...
    cat         cato_bedding_angle FK         "Table 13.18"
    txt         txt_bedding_angle_name        "Table 13.18"
    txt         txt_bedding_angle_desc        "Table 13.18"
  } 
  
  fracture_patterns {
    id          id_fracture_pattern PK 
    cat         catu_fracture_pattern FK         "Table 13.19"
    txt         txt_fracture_pattern_name        "Table 13.19"
    txt         txt_fracture_pattern_desc        "Table 13.19"
  }   
  
  fracture_orients {
    id          id_fracture_orient PK 
    cat         catu_fracture_orient FK         "Table 13.20"
    txt         txt_fracture_orient_name        "Table 13.20"
    txt         txt_fracture_orient_desc        "Table 13.20"
  }   
