...
erDiagram
  ...
  nzsc_parent_material_origin {
    id          id_pmo PK
    cat         catu_pmo FK             "Table 25.5"
    txt         txt_pmo_name            "Table 25.5"
    txt         txt_pmo_desc            "Table 25.5"  
  }
...
erDiagram
  ...
  horizon_arch {
    ...
    cat        catu_structure_type FK            "Section 14.1.1"
    cat        cato_structure_grade FK           "Section 14.1.2"
    cat        catu_structure_shape FK           "Section 14.1.3"
    cat        cato_structure_size FK            "Section 14.1.4"
  ...
  structure_types {
    ...
    cat         catu_structure_type FK    "Table 14.1"
    txt         txt_structure_type_name   "Table 14.1"
    txt         txt_structure_type_desc   "Table 14.1"
  }

  structure_grades {
    id          id_structure_grade PK      
    cat         cato_structure_grade FK    "Table 14.2"
    txt         txt_structure_grade_name   "Table 14.2"
    txt         txt_structure_grade_desc   "Table 14.2"
  }

  structure_sizes_rapid {
    id          id_structure_size_rapid PK      "Section 14.1.4"
  ...
  horizon_structures {
    ...
    cat        catu_structure_type FK     "Section 14.1.1"
    cat        cato_structure_grade FK    "Section 14.1.2"
    cat        cato_structure_shape FK    "Section 14.1.3"
    num[0-Inf] amt_structure_size_med_mm  "Section 14.1.4" 
    num[0-Inf] amt_structure_size_min_mm  "Section 14.1.4" 
    num[0-Inf] amt_structure_size_max_mm  "Section 14.1.4"
  }
  

  structure_shapes {
    id          id_structure_shape PK     
    cat         catu_structure_shape FK        "Table 14.3"
    txt         txt_structure_shape_name       "Table 14.3"
    txt         txt_structure_shape_desc       "Table 14.3"
  }
  ...
  horizon_rock_fragments {
    ...
    cat        catu_rock_fragment_lithology FK  "Section 25.1.2"
  }
  ...
  nzsc_lithologies {
    ...
    cat         catu_nzsc_lithology FK        "Table 25.2"
    txt         txt_nzsc_lithology_name       "Table 25.2"
  }
  ...
  horizon_plastics {
    ...
    id         id_horizon PK
    id         id_plastic PK
    cat        catu_plastic FK          "Table 14.8"
    num[0-100] num_plastic_p            "Section 14.2.4"
    cat        cato_plastic_fixation    "Table 14.9"
    cat        catu_plastic_shape       "Table 14.10"
    cat        cato_plastic_degradation "Table 14.11"
  } 
  
  plastic_types {
    id          id_plastic PK
    cat         catu_plastic FK        "Table 14.8"
    txt         txt_plastic_name       "Table 14.8"
    txt         txt_plastie_desc       "Table 14.8"
  }

  plastic_fixations {
    id          id_plastic_fixation PK
    cat         catu_plastic_fixation FK        "Table 14.9"
    txt         txt_plastic_fixation_name       "Table 14.9"
    txt         txt_plastic_fixation_desc       "Table 14.9"
  }  
  
  plastic_shapes {
    id          id_plastic_shape PK
    cat         catu_plastic_shape FK        "Table 14.10"
    txt         txt_plastic_shape_name       "Table 14.10"
    txt         txt_plastic_shape_desc       "Table 14.10"
  }    
  
  plastic_degradations {
    id          id_plastic_degradations PK
    cat         catu_plastic_degradations FK        "Table 14.11"
    txt         txt_plastic_degradations_name       "Table 14.11"
    txt         txt_plastic_degradations_desc       "Table 14.11"
  }   
  ...
  horizon_roots {
    ...
    id         id_horizon PK
    id         id_root PK
    cat        cato_root_size FK           "Table 14.12"
    cat        cato_root_pos FK            "Table 14.13"
    num[0-100] num_root_p                  "Section 14.3.1"
  } 

  root_sizes_simple {
    id          id_root_size PK     
    cat         catu_root_size FK         "Table 14.12"
    txt         txt_root_size_name        "Table 14.12"
    txt         txt_root_size_desc        "Table 14.12"
  }
  
  root_positions {
    id          id_root_pos PK     
    cat         catu_root_pos FK         "Table 14.13"
    txt         txt_root_pos_name        "Table 14.13"
    txt         txt_root_pos_desc        "Table 14.13"
  }
  ...
  horizon_voids {
    ...
    id         id_horizon PK
    id         id_void PK
    cat        catu_void FK                 "Table 14.14"
    cat        catu_void_conn FK            "Table 14.15"
  ...
  void_types {
    id          id_void PK 
    cat         catu_void FK              "Table 14.14"
    txt         txt_void_name             "Table 14.14"
    txt         txt_void_desc             "Table 14.14"
  }  

  void_conns {
    id          id_void_conn PK 
    cat         catu_void_conn FK         "Table 14.15"
    txt         txt_void_conn_name        "Table 14.15"
    txt         txt_void_conn_desc        "Table 14.15"
  }  
...
erDiagram
  ...
  horizon_texture {
    ...
    cat         catu_texture_sandmod FK   "Section 16.2.1"
    cat         catu_texture_orgmod FK    "Section 16.2.2"
    cat         catu_organic_type FK      "Section 16.4"
    cat         catu_organic_decomp FK    "Section 16.4.1"
    cat         catu_organic_minmod FK    "Section 16.4.2"
  ...
  organic_types {
    ...
    cat         catu_organic_type FK    "Table 16.6"
    txt         txt_organic_type_name   "Table 16.6"
    txt         txt_organic_type_desc   "Table 16.6"
  }
  
  organic_decomps {
    id          id_organic_decomp PK
    cat         catu_organic_decomp FK    "Table 16.7"
    txt         txt_organic_decomp_name   "Table 16.7"
    txt         txt_organic_decomp_desc   "Table 16.7"
  }
...
Conventional horizon names in the New Zealand system are difficult to store in a structured manner due to the large number of ways the various components can be combined (@sec-hzn-conv). The above implementation, where the full list of 'legal' names (e.g. Ap, App, Apg, A/Bw ABw, etc) are anticipated and stored, is the simplest approach. It offers a compromise between ease of data entry and ease of querying, leaning more towards the former. 
:::
