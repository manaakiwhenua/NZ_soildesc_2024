...
erDiagram
  ...
  horizon_voids {
    ...
    cat        catu_void_conn FK            "Table 13.15"
    num[0-100] num_void_p                   "Section 13.4"
  } 
...
erDiagram
  ...
  horizon_texture {
    id          id_site PK
    id          id_horizon PK
    cat         catu_texture_simple FK    "Section 15.1.1"
    cat         catu_texture FK           "Section 15.1"
    cat         catu_texture_sandmod FK   "Section 15.2.1"
    cat         catu_texture_orgmod FK    "Section 15.2.2"
    cat         catu_organic_type FK      "Section 15.4"
  ...
  simple_textures {
    ...
    cat         catu_simple_texture FK    "Table 15.3"
  ...
  mineral_textures {
    id          id_texture PK
    cat         catu_texture FK           "Table 15.2"
...
erDiagram
  ...
  pan_types {
    ...
    txt         txt_pan_form_name   "Table 16.4"
    txt         txt_pan_form_desc   "Table 16.4"
  }
...
erDiagram
  ...
  consistence_tests {
    ...
    cat         catu_induration FK          "Section 17.11"
  }
  ...
  indurations {
    id          id_induration PK
    cat         catu_induration FK         "Table 17.9"
...
erDiagram
  ...
  horizon_names {
    ...
    cat         catu_horizon_name FK      "Sections 20.1.1-4"
  ...
  horizon_names_conventional {
    ...
    cat         catu_horizon_name_conv FK        "Tables 20.2-9"
    txt         txt_horizon_name_conv_name       "Tables 20.2-9"
    txt         txt_horizon_name_conv_desc       "Tables 20.2-9"
  }
