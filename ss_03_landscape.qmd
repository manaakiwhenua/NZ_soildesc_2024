...
tbl_hr_lfnames <- gt(dat_hr_lfnames) |>
  ...
  tab_style(style = list(cell_text(color  = 'red',
                                   ...
                                   align  = 'center')),
            locations = cells_body(columns = 1)) |>
  tab_row_group(label = 'Natural', rows = 1:30, id = 'n') |>
  tab_row_group(label = 'Human-induced', rows = 31:35, id = 'a') |>
...
Where available landforms are unsatisfactory or a more detailed parameterisation of the landform is desired, the landform can optionally be described in terms of its relief slope, orientation and element.

#### Relief {#sec-gmph-lfmrel}

As for landscapes (@sec-gmph-lscrel), record the relief of the landform in meters. Relief classes may be applied to the recorded data; see @sec-reliefclass.
