...
Aspect should be measured at the same time and over the same transect as slope. Record aspect in whole degrees clockwise from North, using the range \[0-359\] (360 == 0). Use [NA]{.ceg} for flat ground. Use [NR]{.ceg} if unable to record.

For rapid assessment, record compass bearing on an 8 or 16 point scale (e.g. [NE]{.ceg}, [SSE]{.ceg}).

-   [TODO Note: defining 'flat' in soil survey.]{.todo}
-   [TODO Note: map vs magnetic north, and consequences for field-measured vs DEM-derived aspect measurements]{.todo}

### Landform element morphology

The following is adapted from [@nationalcommitteeonsoilandterrain2009, pp. 19-26].

Landform elements can be assigned to a morphological type - one of a series of simple shapes - at the scale of observation. These are:
...
-   shortcut terms, noting that they don't form a conceptual tesselation
-   longform descriptions
-   NB 10.1016/j.geomorph.2019.04.020 for loess landslide terms
