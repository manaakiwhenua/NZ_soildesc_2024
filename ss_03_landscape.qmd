...
dat_gmph_lsnames <-
  tribble(~Code, ~Name, ~Description, ~Synonyms,
          ...
          'Vo', 'Volcanoes', 'Moderate to very steep, usually high relief (>150 m), often with a radial drainage pattern with high to moderate stream power that has been interrupted by past eruptive events', '',
          ...
          'Ll', 'Lowlands', 'Gentle to very steep, low relief (30–90 m) and elevation, sometimes loess-covered, fixed and well connected drainage pattern with low stream power, shallow to deep', 'Downlands',
          'Vl', 'Volcanic lowlands', 'Level to gentle, very low relief (9–30 m), sometimes highly uneven or hummocky surfaces created by eruptions, lahars and debris avalanches, often blanketed in airfall tephra. Drainage pattern has variable stream power and may be discontinuous or even absent', 'Moundplains, ringplains, scoria fields', 
          ...
          'Ri', 'Rises' , 'Very gentle to steep, very low relief (9–30 m) and elevation, sometimes loess-covered, variable drainage pattern with low to moderate stream power', '',
          'Pl', 'Plains', 'Level to very gentle surfaces with very low relief (<9 m) created by fluvial and/or aeolian deposition. Active, migrating drainage pattern with shallow to deep channels and variable stream power, subject to flooding', 'Floodplains',
          'Sc', 'Sand country', 'Extensive dune and sandplain areas. Low to moderate relief (9–90 m) and elevation, gentle to steep slopes, and active drainage pattern of variable power, often with interrupted connectivity', 'Dunefields',
...
::: {#nte-multislopes .callout-note appearance="minimal" collapse="true" title="Multiple characteristic slopes"}
...
dat_gmph_lfnames <-
  tribble(~Code, ~Name, ~Description, ~Synonyms,
          ...
          'Bp', 'Beach plain', 'Coastal plain built up by wave and tidal action on an aggrading coastline', 'strand plain, chenier plain',
          ...
          'Se', 'Seepage', 'Sloped area carrying a slow but steady flow of groundwater emerging at the land surface', 'Flushes',
          ...
          'Tf', 'Tidal flat', 'Low-lying coastal flat subject to inundation by saline or brackish waters as a result of tidal action', 'intertidal flat, supratidal flat, extratidal flat',
          'Va', 'Valley', 'Linear open depression with gentle to steep sides, created primarily by fluvial erosion, usually with an active or seasonally active flowing channel in its base', 'Drainage line',
          'Vf', 'Valley-flat', 'Open, very low-slope to flat depression between steeper parallel facing slopes, with a flat base in cross-section', '',
...
tbl_gmph_lfnames <- gt(dat_gmph_lfnames) |>
  ...
  tab_row_group(label = 'Natural', rows = 1:45, id = 'n') |>
  tab_row_group(label = 'Human-induced', rows = 46:49, id = 'a') |>
...
The characteristic slope of the major part of the landform should be recorded as median and range in whole degrees. Slope classes may be applied to the recorded data; some options are presented in @sec-slopeclass.
...
The following is adapted from @ncst2024.
