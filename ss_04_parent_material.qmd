...
-   If the soil description is being completed for S-map, which requires classification down to the 5th level of the NZSC, the NZSC rock class must be recorded [@webb2011]. The classes are listed in @tbl-ss-pm. 
-   
