...
For routine assessment, add continuity (@tbl-hr-pancont) and structure (@tbl-hr-panstr), e.g., [FBS]{.ceg} for a vesicular iron-pan that has been broken up by deep ripping.
