...
dat_hr_concform <-
  tribble(~Code, ~Name, ~Description,
          ...
          'LM', 'Lamellae', 'A thin band of uncemented material with sharp upper and lower boundaries, horizontally oriented or running parallel to the land surface')
...
::: {#nte-laml .callout-note appearance="minimal" collapse="true" title="Describing lamellae"}
Lamellae are technically separate horizons, however where multiple similar lamellae occur within a larger band of material that has consistent composition they may be described as concentrations for the sake of brevity (e.g. [LM L]{.ceg} for a series of thin clay bands observed in a larger sandy layer). If a single lamella is evident between two contrasting horizons, e.g. at the base of an E horizon, then it must be described as a separate horizon rather than as a concentration. For more detailed discussion of lamellae, see @rawling2000; @bockheim2013.
:::
