...
dat_hr_pantype <-
  tribble(~Code, ~Name, ~Description, ~Horizon,
          ...
          'X', 'Fragipan', 'An unstructured, uncemented but high-density, erosion-resistant layer common to Pallic soils', '\\*x (B or BC horizons)',
