...
dat_hr_coattype <-
  tribble(~Code, ~Name, ~Description,
          ...
          'SI', 'Silica coats', 'Precipiated silica (SiO~2~). Usually pale-coloured, and non-reactive to HCl.')
