...
::: {#nte-hzn-cls .callout-note collapse="true" appearance="minimal" title="Soil horizons and classification systems"}
...
::: {#imp-stp .callout-important collapse="true" appearance="minimal" title="Defining horizons on steep slopes"}
...
For rapid assessment, dominant lithology is recorded once for the site (@sec-ss-recgmph). Where the subsolum is encountered, note its lithology (@sec-reg-lith) separately if it differs from the overlying material.

Example: [ANDS, SAFT]{.ceg} for a mix of eroded sedimentary rocks and volcanic ash.

For routine assessment, the lithology of the fine earth (mineral particles \<2 mm) is noted separately for each soil horizon, as are any rock fragments observed in each horizon (see also @sec-rockfrag). In the subsolum, each distinct layer observed should have its lithology captured separately. In all cases, use the codes in @tbl-ss-pm and record only the dominant lithologies present.

For detailed assessment, a more complete list of lithologies may be defined for each mineral component.
...
|            |                      |                                                                                                                                                                                                                                                                                                                          |
|            |                      | - anthropogenic or pedogenic structure (@sec-str-origin),                                                                                                                                                                                                                                                                |
...
::: {#nte-stp .callout-note collapse="true" appearance="minimal" title="Degree of weathering and the New Zealand Soil Classification"}
...
::: {#nte-hzn-tmb .callout-note collapse="true" appearance="minimal" title="Recording specific parent materials"}
In New Zealand, and particularly on the North Island, many soils form in cover beds linked to specific volcanic events (e.g. ash from the 232 AD Taupō eruption). The presence of these stratigraphic 'marker beds', which may comprise horizons or subsolum layers, should be noted as free text where they are observed.
:::
