...
When examining single small cores or auger points on a local landform (see @tbl-pr-gear, type [A]{.ceg}, [C1]{.ceg} and perhaps [C2]{.ceg}), record the observable upper and lower depth of each horizon in whole centimetres (e.g. "28-38cm").
...
[change point - abandoning occluded as a modifier to the other codes, giving it its own code instead.]{.majch}
...
[change points - using WRB cutoff for gradual/diffuse (15 not 10 cm), dropping diffuse as an option]{.majch}
...
-   discussion of field vs lab measurement]{.todo}

[QN: keep this here or move to e.g. consistence???]{.todo}

## Depth to free water

Depth to free water can be determined from the upper depth of the first saturated horizon, or specifically recorded in whole centimetres. Depending on the soil's transmissivity, the presence of water table may be revealed by the pit or core filling with water. 

[add comment on how long a wet core or pit should be expected to take to equilibrate]{.todo}