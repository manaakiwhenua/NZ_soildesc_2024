...
When examining single small cores or auger points on, (see @tbl-pr-gear, type [A]{.ceg}, [C1]{.ceg} and perhaps [C2]{.ceg}), record the observable upper and lower depth of each horizon from the soil surface in whole centimetres.
...
Measure boundaries to and from the midpoint of each horizon transition zone (see @sec-hr-bdydist).
...
[Add xref to an appendix about soil water field measurement]{.todo}
...
[figure out how to minimise redundancy vs land surface water codes]{.todo}
