...
For rapid assessment, lithology is recorded at the landform level (@sec-ss-pm).

For routine assessment, the lithology of the fine earth (mineral particles \<2 mm) and of rock fragments (if present) are noted separately for each soil horizon. Where subsolum layers are observed, their lithology is also noted. Use the codes in @tbl-ss-pm and record only the dominant lithologies present.

For detailed assessment, a more complete list of lithologies may be defined, along with relative abundance as percentage by volume.
