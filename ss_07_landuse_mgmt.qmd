...
![Overview of the New Zealand Land Use Management classification system (reproduced from @law2024, p. 44)](data/nzluc_snip.png){#fig-ss-nzluc fig-alt='A diagram of the NZ Land Use CLassification' width=95%}
