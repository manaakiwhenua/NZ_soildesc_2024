...
Estimate the areal percentage of the cut exposure face occupied by the colour pattern, versus the matrix colour. Use the visual guides in @sec-in-abundpics to help estimate accurately. Abundance data can be classified according to @tbl-hr-abgen where needed.
