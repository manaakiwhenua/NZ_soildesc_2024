...
## Size classes for solid soil components
...
dat_in_fhtx <-
  tribble(~Code, ~Name, ~Description,
         'A', 'Sandy',          'Sand and Loamy Sand [texture classes](hr_03_texture_stones.qmd#sec-hr-tex)',
         'L', 'Loamy or Silty', 'Loamy and Silty [texture classes](hr_03_texture_stones.qmd#sec-hr-tex)',
         'Y', 'Clayey',         'Clayey [texture classes](hr_03_texture_stones.qmd#sec-hr-tex)', 
...
dat_in_fhtxx <-
  tribble(~Code, ~Name, ~Description,
         'a', 'Dune sand', 'Clean, [medium to coarse sand](hr_03_texture_stones.qmd#tbl-hr-sandquals)',
