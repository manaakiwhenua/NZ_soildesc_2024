...
-   A soft- or hard-rock surface (M rooting barrier, @sec-profbar)
-   A shattered-lithic contact (F rooting barrier, @sec-profbar)
-   A pan (Q functional horizons, @sec-in-fh-tx)
-   Firm strength with massive or coarse structure (\*Cf functional horizons, @sec-fh-name)
...
Rooting barriers may be identified in some soils, potentially determining their Family and Sibling codes. Use [N]{.ceg} to confirm no barrier.
...
: Horizon-specific root barriers [@lilburne2021] {#tbl-fhb-one cols=width=\[10,20,70\]}
...
+----------+----------------+--------------------------------------------------------------------------------+
| **F**    | Fractured rock | -   [Lithic contact]{.underline} present within top 100 cm                     |
|          |                | -   Fractures are ≥ 30 cm apart                                                |
+----------+----------------+--------------------------------------------------------------------------------+
| **M**    | Massive Rock   | -   [Lithic]{.underline} or [paralithic contact]{.underline} within top 100 cm |
|          |                | -   If fractures are present, they are \> 30 cm apart                          |
+----------+----------------+--------------------------------------------------------------------------------+

: Whole-profile root barriers [@lilburne2021] {#tbl-fhb-two cols=width=\[10,20,70\]}
