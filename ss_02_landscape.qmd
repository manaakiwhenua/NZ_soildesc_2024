...
The characteristic slope is the most common range of slopes within a regional landscape. These are often controlled by local geology. This measure is often expressed as the modal value among a set of slope classes, but can also be expressed as a median value plus or minus an appropriate range (e.g. 1 standard deviation to capture 68% of slopes in a landscape).

Characteristic slope is usually best determined from a DEM-derived slope dataset, but can be estimated in the field. Record as a \[low, high\] range of degrees.
