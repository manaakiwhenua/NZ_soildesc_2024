...
![A researcher using a post driver to extract a [C1]{.ceg} style core in the Ranigitikei River valley.](data/mwlr_postdriver.png){width=70% .lightbox alt="A researcher using a post driver to extract a [C1]{.ceg} style core in the upper Ranigitikei River valley."}
...
![A pedologist using a small excavator to dig a [P2]{.ceg} style pit in Northland](data/mwlr_excavator.png){width=70% .lightbox alt="A pedologist is seen operating a small mechanical excavator to open up a large sampling pit on an alluvial plain in Northland."}
