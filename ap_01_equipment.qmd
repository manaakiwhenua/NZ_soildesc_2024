...
![A researcher using a post driver to extract a \[C1\]{.ceg} style core in the upper Rangitikei River valley.](data/mwlr_postdriver.png){.lightbox width="70%"}
...
![A pedologist is seen operating a small mechanical excavator to open up a large sampling pit on an alluvial plain in Northland.](data/mwlr_excavator.png){.lightbox width="70%"}
