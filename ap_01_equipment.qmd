...
![A researcher using a post driver to extract a [C1]{.ceg} style core in the Ranigitikei River valley.](data/mwlr_postdriver.png){width=70% .lightbox alt="A researcher using a post driver to extract a [C1]{.ceg} style core in the upper Rangitikei River valley."}
