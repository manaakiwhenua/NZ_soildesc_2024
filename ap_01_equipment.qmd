...
Mechanical post drivers can be adapted to push [C1]{.ceg} sampling tubes in as deep as 1.5 m, provided the substrate is minimally stony and soil moisture conditions are favourable.
...
Mechanical augers are not recommended as they disturb the soil profile too much for a reliable description.

## Profile description tools

Essential small tools for a field sampling kit include:

-   Pit tape with large markings, 1-5 m
...
-   Small 2-mm sieve for removing fine gravel
