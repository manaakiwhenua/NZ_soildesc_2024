...
## Profile exposure tools {#sec-gear-dig}
...
[C2]{.ceg} (@tbl-pr-gear) style tube samplers can be manually inserted with a steel post driver and sampling depths of up to 1 m are usually achievable.

### Mechanical {#sec-mechtools}

Mechanical post drivers can be adapted to push [C2]{.ceg} sampling tubes in as deep as 1.5 m, provided the substrate is minimally stony and soil moisture conditions are favourable. Sampling in 30–50 cm sections may be necessary in some cases.

![A researcher using a post driver to extract a [C1]{.ceg} style core in the upper Rangitikei River valley.](data/mwlr_postdriver.png){#fig-corer width="70%"}
...
![A pedologist is seen operating a small mechanical excavator to open up a [P1]{.ceg} sampling pit on an alluvial plain in Northland.](data/mwlr_excavator.png){#fig-digger width="70%"}
...
## Peat sampling {#sec-gear-peat}

Sampling peats can be challenging due to their flexible structure and high water content. Advice on peat-specific extraction devices can be found in @dettmann2022 and @agus2011.

## Profile description tools {#sec-gear-liltools}
...
- Munsell colour book
- Putty knife or trowel (plus a plastic option for sampling reduced horizons)
- Spray bottle or pressure sprayer for water
- Nails, golf tees or small marker flags for noting horizon boundaries (and pinning the pit tape into place)
- Cleaning cloths
- Notepad/pen, or electronic field recording device
- Camera or smartphone
- GPS
- Batteries and/or power packs and charging cables for electronics
- Clinometer
- Compass
- Plastic sample bags
- Permanent markers
- Tarpaulin or mat for laying out excavated profiles (a minimum 100 mm diameter polyethylene half-pipe or flat wooden board may also be used for auger samples).

Optional, but useful tools include:

- Small-diameter 2 mm sieve for removing fine gravel before texturing
- Rock hammer
- Sand-grade sieves for separating sand fraction subdivisions
...
- Small whiteboard and markers, for noting site identifiers in profile photographs.
- Extendible snap-blade knife, for precise sample excision in moist soils
- Niwashi gardening tool, for cleaning up pit faces and exposures
- Plastic frame with internal dimension of 100 cm^2^ for root count assessment (or delineate an area with nails and twine)

A complete field kit should fit in a medium-sized toolbox or sturdy backpack.

## Field test equipment {#sec-gear-fieldtest}
...
![A photo of an open multi-compartment storage box containing field test kit reagents in small dropper bottles. The box is roughly 20 by 35 cm.](data/mwlr_testkit.png){#fig-fieldkit .lightbox fig-align="center" width="50%"}

Portable electronic meters (e.g. for pH or EC) should travel in their own containers along with calibration and cleaning equipment, as well as sample containers and a rack to hold them (@sec-ft-phfw, @sec-ft-phfox, and @sec-ft-ec) . A small toolbox will usually suffice.
