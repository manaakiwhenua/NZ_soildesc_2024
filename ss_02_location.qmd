...
Location accuracy is largely a function of the equipment available and the quality of data recording, but should ideally be within 5 m of true. Location precision must be recorded to a minimum of 5 m but does not need to exceed 1 m for pits, or 0.1 m for cores and auger holes. Z precision will rarely need to exceed 0.1 m.
