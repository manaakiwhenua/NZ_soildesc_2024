...
Where the [A]{.ceg} code is used, the time and location of the most recent altimeter calibration should be noted. Hand altimeters can be expected to be accurate to within ± 3 m.
