...
Location data quality can sometimes be improved by revising the location data in GIS after fieldwork, with reference to e.g. satellite imagery. Where corrections are made, expected error from the measuring instrument should be overridden with a new manual estimate of expected error. Document how and why the revision decision was made.
:::
...
### Recroding administrative location {#sec-loc-admin}
