...
Names as shorthand for full profile descriptions
...
The following suffixes can be added to most [**E**]{style="color: red"}, [**B**]{style="color: red"}, or [**C**]{style="color: red"} horizons to signify the degree to which they have been affected by water saturation and reducing conditions, e.g. [**Bg**]{style="color: red"}. Some exceptions exist:

-   [**g**]{style="color: red"} and [**r**]{style="color: red"} suffixes cannot be used with [**Ew**]{style="color: red"} or [**Bw**]{style="color: red"} horizons, which are defined by their development under well-aerated conditions.
-   [**g**]{style="color: red"} and [**r**]{style="color: red"} suffixes cannot be used with [**Cu**]{style="color: red"}, as it is partly defined by a lack of strong gleying.
...
One or more of these suffixes may be added to the designations defined above to provide more specific information about a horizon. For example, a [**Bg**]{style="color: red"} horizon containing more than 5% by volume of concretions is designated [**Bgc**]{style="color: red"}.
...
-   Numbers [**1**-***N***]{style="color: red"} may be used to signify lithological discontinuities, where the parent material changes significantly between layers e.g. [**2C**]{style="color: red"}
