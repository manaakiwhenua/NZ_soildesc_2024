...
Microrelief occurs within a landform, so its components are smaller than the landform itself - usually too small to be sensed remotely. Microrelief emerges from slope processes, biota and climate effects. Its presence helps signify particular soil types and influences many small-scale soil processes such as local water infiltration, accumulation of surface litter, and topsoil development.
