...
Optional detail may be added to the landscape description using the options in @sec-gmph-lscpar, and to the landform using the options in @sec-gmph-lfmdsc.
