...
Optionally, record the current weather using an option from @tbl-ss-weatherc, and note the temperature. Describe any recent rainfall using @tbl-ss-weatherp.
