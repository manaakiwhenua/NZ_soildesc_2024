...
The soil profile description starts with an observation of the site's surface and works down. The chief task is delineating soil layers, or horizons, and describing their morphological character. Prior to that, some additional reference data should be recorded:
...
Record the maximum depth of observation from the soil surface in whole centimetres (e.g. '[100 cm]{.ceg}').
