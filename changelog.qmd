...
-   Inherently numeric properties are now recorded as numbers; either single measurements, median-plus-range, or low-high range as appropriate. Options for classifying numeric parameters for ease of communication are presented in the Interpretations section.\
...
-   **MOVE** Chapter 'Reference data' into this section
    -   **ADD** location coordinates as required metadata (@sec-ss-ref-loc, and crosslink to more detailed discussion of requirements in chapter 'Location')
    -   **ADD** Site purpose @sec-ss-ref-why
    -   **ADD** Site selection method @sec-ss-ref-sampstrat
...
-   **ADD** separate instructions for recording horizon depths, based on whether a large section of profile is visible and on whether detailed assessment is desired.
