---
title: "Changes in the third edition"
editor: visual
format:
  html: 
...
- Parameters required for the *New Zealand Soil Classification* (NZSC) have been updated where needed in alignment with the simultaneous review of that document
...
- **ADD** Chapter [Parent material](ss_04_parent_material.qmd#sec-pm), discussing ways to record geological and lithological information. General commentary on the use of geological maps is included but there is no requirement to record geological map code or similar, due to scale and purpose differences. A new rock class list organised around origin, mineralogy, grain size and hardness is also added.\
...
- **UPDATE** 'Geomorphic position' to [Geomorphology](ss_03_geomorphology.qmd#sec-gmph), with a more structured method of geomorphology description.
