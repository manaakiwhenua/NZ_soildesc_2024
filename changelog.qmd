...
-   **UPDATE** pedality grade to describe a clear gradient of progressively stronger ped development (Single-grain –\> Massive –\> Weak –\> Moderate –\> Strong). Separate non-ped structures e.g. casts, clods into a 'D = disturbed' grade.
...
-   A single unified set of size classes has been presented for classifying all macrofabric @tbl-in-size
