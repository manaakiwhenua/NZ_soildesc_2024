...
Note that the Handbook does not provide fully closed limits for slope classes. For consistency, slope class A should be considered to be 0 - ≤4, B as \>4 - ≤8, etc.
:::
