...
Pedality refers to the degree of structural development evident within the horizon, independent of size or shape. For rapid assessment, record pedality once per horizon using @tbl-hr-pedality. For routine or detailed assessment, record pedality for each nested ped observed (if more than one is seen; see @sec-hr-stru-nest).
...
dat_hr_pedality <-
  tribble(~Code, ~Name,  ~Description,
          ...
          'D', 'Disturbed', 'Material where ped structure has been altered or destroyed by disturbance, e.g. recent tillage or animal pugging')
...
::: {#nte-nut .callout-note appearance="minimal" collapse="true" title="shorthand terms for soil structure"}
...
For rapid assessment, the dominant ped size may be recorded consistent with the NZSC Functional Horizon convention - (@tbl-in-fhstr, [C]{.ceg} for Coarse or [F]{.ceg} for Fine).
...
dat_hr_adeg <-
  tribble(~Code, ~Name, ~Description,
         'N', 'Not verifiable', 'Designation not possible / uncertain',    
         'F', 'Fresh', 'Fresh plastic pieces with bride colours, unaffected shape, without signs of deterioration (cracks, broken edges, rough surfaces)', 
