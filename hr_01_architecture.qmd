...
dat_hr_form <-
  tribble(~Code, ~Name,  ~Description,
          ...
          'UK', 'Unknown', 'Type of structural development could not be determined with confidence')
...
Both structures are more correctly described as type [P]{.ceg} with SR shape. 'Crumbs' have a size range of about 1 ± 0.5 mm and 'nuts' are about 15 ± 10 mm. Their use as a shorthand description is convenient, but the terms should not be used in databases because they conflate size and shape in a way that the modern schemas seek to avoid.
