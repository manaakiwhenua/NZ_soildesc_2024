...
Surface cover helps visualise the Landform and provides some information on infiltration behaviour. 
...
dat_pr_surfcov <-
  tribble(~Code, ~Name, ~Description,
          ...
          'BR', 'Fragments', 'Bare rock fragments, shells, or bones, > 2 mm',
          'BO', 'Rock', 'Bare rock outcrop',
...
[GRAPHIC: Turn the above into a 3x3 grid with labels underneath conceptual diagrams]{.diag}
