...
dat_pr_surfcov <-
  tribble(~Code, ~Name, ~Description,
          'BE', 'Earth', 'Sediment or soil, < 2 mm', 
          'BR', 'Fragments', 'Rock fragments, shells, or bones, > 2 mm',
...
Where surface water is present within the landform, as well as noting its areal dominance above, note the type and degree of persistence using the codes in @tbl-pr-swater and @tbl-pr-swaterp below.
...
Small-scale human alterations to the soil surface are common in agricultural areas (current and former). These include creation of microrelief, but just as commonly its removal. 
