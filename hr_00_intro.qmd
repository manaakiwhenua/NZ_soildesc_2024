...
[change points - using WRB cutoff for gradual/diffuse (15 not 10 cm); using Aus codes for uniqueness (Distinct and Diffuse were problematic).]{style="background-color:orange"}
