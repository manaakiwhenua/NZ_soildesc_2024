...
These fractions can be communicated as percentage by volume, adding to 100%. The fine-earth fraction also has its own compositional data based on finer divisions of the <2 mm fraction (see @sec-tex-fine).

[complicated exploding pie chart or similar goes here]{.diags}

## Architecture

The architecture of the physical components - how they are spatially arranged - is described in terms of the fine earth structure (#sec-structure), as well as visible surface features and...
