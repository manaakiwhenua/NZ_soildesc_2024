...
When examining single small cores or auger points on a local landform (see @tbl-pr-gear, type [**A, C1 and perhaps C2**]{style="color:red"}), record the observable upper and lower depth of each horizon in whole centimetres (e.g. "28-38cm").

Where a wider exposure (see @tbl-pr-gear, type [**E, P1, P2**]{style="color:red"}) or multiple undisturbed cores are available on a local landform and greater detail is desired, one may choose to record upper and lower depths as a median and range, again in whole centimetres (e.g. "28cm (27-29), 38 cm (37-40)"). At least 5 measurements should contribute to such an assessment.
...
Horizon boundary shape can only be observed on wider exposures (see @tbl-pr-gear, type [**E, P1, P2**]{style="color:red"}). Record against the following schema:
