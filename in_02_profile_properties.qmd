...
dat_in_intdrng <-
  ...
  '0 - 15', 'PO, VP', 'MW, IP, PO', 'WE, MW, IP',     'WE, MW',     'WE',
 '15 - 30',     'VP', 'MW, IP, PO', 'WE, MW, IP',     'WE, MW',     'WE',
 '30 - 60',     'VP',     'PO, VP',     'IP, PO',     'WE, MW',     'WE',
 '60 - 90',     'VP',     'PO, VP',     'IP, PO',     'MW, IP',     'WE',
    '> 90',     'VP',     'PO, VP', 'IP, PO, VP', 'MW, IP, PO', 'WE, MW')
...
dat_in_profdrng <-
  tribble(~Code, ~Name, ~relel, ~Landform, ~Slope, ~Veg, ~Other, 
         ...
         'IP', 'Imperfect', 'Variable', 'Slopes, hollows, flats in front of slopes', 'Gentle to moderately steep', '', '',
         'MW', 'Moderately Well', 'Variable', 'footslopes and fans', 'Gentle to moderately steep', '' ,'',
         'WE', 'Well', 'Moderate to high (>10 m)', 'crests, ridges and spurs', 'Gentle to very steep' , '', '' , '')
