...
-   note: use classifications where numerical data can't be reliably obtained
...
Various classifications specific to New Zealand have been produced [@robertson1956; @garr1991; @sturman1999].

NIWA have more recently published a useful summary classification at https://niwa.co.nz/climate-and-weather/overview-new-zealands-climate, although it is not accompanied by spatial data. The classification is briefly reproduced in @tbl-ss-climnz below.
...
Soil formation, as a long-term phenomenon, has in many cases a stronger connection to past climates than the present one. Understanding of New Zealand paleoclimates is relatively well-developed, partly due to the intensive study of volcanic and seismic activity on the North Island [@williams2015]. ...
...
e.g. [**SU 23**]{style="color: red"} for a perfect day in the field.
